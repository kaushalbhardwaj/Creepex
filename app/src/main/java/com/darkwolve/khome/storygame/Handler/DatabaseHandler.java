package com.darkwolve.khome.storygame.Handler;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "storygame";
    private static final String TABLE_CONTACTS = "chat3";
    ...
    public void addMessage(Message msg) {
        ...
        values.put(KEY_TEXT, msg.getText()); // Contact Name
        values.put(KEY_PH_NO, msg.getId()); // Contact Phone
